...
<body class="fade-in">
  ...
  <div class="container">
    ...
    echo "<img src=".$info['Image1']." style=\"height:120px\">";
    echo "</div>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
    ...
    echo "</div>";
    echo "<br>";
    echo "<form id=\"formedit\" role=\"form\" action=\"creationPersonne.php\" method=\"post\" enctype=\"multipart/form-data\">";
    ...
    echo '<label for="img">Image de fond</label>';
    echo '<input type="file" class="form-control" id="img" name="Test" accept="image/png, image/jpg, image/jpeg">';
    echo '</div>';
    echo '</div>';
    echo '</div>';
    echo '<div class="form-row">';
    ...
    echo '</div>';
    echo '</div>';
    echo '<input type="reset" onclick="location.href=\'compte.php\'" class="btn btn-secondary" value="Annuler">';
    echo '<button type="submit" id="save" class="btn btn-primary">Sauvegarder</button>';
    echo '<br>';
    echo '<br>';
    echo '<br>';
    echo '</form>';
